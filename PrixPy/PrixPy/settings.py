...
ROOT_URLCONF = 'PrixPy.urls'

TEMPLATE_DIR = os.path.join(CORE_DIR, "index/templates")  # ROOT dir for templates
...
WSGI_APPLICATION = 'PrixPy.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(CORE_DIR, 'index/static'),
)
